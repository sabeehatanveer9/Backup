...
public class PhoneLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputUserPhoneNumber = (EditText) findViewById(R.id.etPhnNum);
        InputUserVerificationCode = (EditText) findViewById(R.id.etVerify);
        SendVerificationCodeButton = (Button) findViewById(R.id.btnCode);
